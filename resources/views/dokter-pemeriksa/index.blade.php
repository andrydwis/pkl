...
<div class="section-body">
    <div class="card card-primary">
        <div class="card-header flex-row justify-content-between">
            <h4>Data</h4>
            <a href="{{route('data-dokter-pemeriksa.create')}}" class="btn btn-primary">Tambah Data</a>
        </div>
        <div class="card-body">
            <table id="users" class="table table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$user->nip}}</td>
                        <td>
                            <a href="{{route('data-dokter-pemeriksa.edit', ['dokterPemeriksaUser' => $user])}}" class="btn btn-primary btn-icon"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus Data Dokter Pemeriksa</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span><i class="fas fa-times-circle"></i></span></button>
            </div>
            <div class="modal-body">
                Apa anda yakin ingin menghapus data Dokter Pemeriksa ini ?
            </div>
            <div class="modal-footer flex justify-content-center">
                <form action="{{route('data-dokter-pemeriksa.destroy', ['dokterPemeriksaUser' => $user])}}" method="post">
                    @csrf
                    @method('DELETE')
