                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('rehabilitasi-instansi.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama_lengkap_pelapor" type="nama_lengkap_pelapor" class="form-control @error('nama_lengkap_pelapor'){{ 'is-invalid' }}@enderror" name="nama_lengkap_pelapor" value="{{ old('nama_lengkap_pelapor') ?? '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nomor_telepon" type="number" class="form-control @error('nomor_telepon'){{ 'is-invalid' }}@enderror" name="nomor_telepon" value="{{ old('nomor_telepon') ?? '' }}">
                                    @error('nomor_telepon')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="jumlah_yang_dicurigai" type="number" class="form-control @error('jumlah_yang_dicurigai'){{ 'is-invalid' }}@enderror" name="jumlah_yang_dicurigai" value="{{ old('jumlah_yang_dicurigai') ?? '' }}">
