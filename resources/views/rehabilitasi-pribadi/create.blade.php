                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('rehabilitasi-pribadi.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="jenis_penyalahgunaan" type="text"
                                            class="form-control @error('jenis_penyalahgunaan'){{ 'is-invalid' }}@enderror"
                                            name="jenis_penyalahgunaan" value="{{ old('jenis_penyalahgunaan') ?? '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="hubungan_dengan_penyalahguna" type="text"
                                            class="form-control @error('hubungan_dengan_penyalahguna'){{ 'is-invalid' }}@enderror"
                                            name="hubungan_dengan_penyalahguna"
                                            value="{{ old('hubungan_dengan_penyalahguna') ?? '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="rencana_kedatangan_ke_klinik" type="date"
                                            class="form-control @error('rencana_kedatangan_ke_klinik'){{ 'is-invalid' }}@enderror"
                                            name="rencana_kedatangan_ke_klinik"
                                            value="{{ old('rencana_kedatangan_ke_klinik') ?? '' }}">
