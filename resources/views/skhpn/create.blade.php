...
>>>>>>> 3ea47b40aff7b6000b4f699fd74059798e9ffdb7
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="jenis_kelamin" id="jenis_kelamin"
                                            ...
                                            <option value="" @if (old('jenis_kelamin') == null) {{ 'selected' }} @endif disabled>-- Jenis
                                                Kelamin --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="tanggal_permohonan" type="date"
                                            class="form-control @error('tanggal_permohonan'){{ 'is-invalid' }}@enderror"
                                            name="tanggal_permohonan" value="{{ old('tanggal_permohonan') ?? '' }}">
