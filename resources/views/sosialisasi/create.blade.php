                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('sosialisasi.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kategori" id="kategori" class="form-control @error('kategori'){{ 'is-invalid' }}@enderror" name="kategori" value="{{ old('kategori') ?? '' }}" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama_penyelenggara" type="nama_penyelenggara" class="form-control @error('nama_penyelenggara'){{ 'is-invalid' }}@enderror" name="nama_penyelenggara" value="{{ old('nama_penyelenggara') ?? '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="jam_pukul" type="time" class="form-control @error('jam_pukul'){{ 'is-invalid' }}@enderror" name="jam_pukul">
                                    @error('jam_pukul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama_pemohon" type="text" class="form-control @error('nama_pemohon'){{ 'is-invalid' }}@enderror" name="nama_pemohon">
                                    @error('nama_pemohon')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="no_hp_pemohon" type="number" class="form-control @error('no_hp_pemohon'){{ 'is-invalid' }}@enderror" name="no_hp_pemohon" value="{{ old('no_hp_pemohon') ?? '' }}">
                                    @error('no_hp_pemohon')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="jumlah_peserta" type="number" class="form-control @error('jumlah_peserta'){{ 'is-invalid' }}@enderror" name="jumlah_peserta" value="{{ old('jumlah_peserta') ?? '' }}">
