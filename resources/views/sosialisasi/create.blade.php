                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('sosialisasi.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama_penyelenggara" type="text" class="form-control @error('nama_penyelenggara'){{ 'is-invalid' }}@enderror" name="nama_penyelenggara" value="{{ old('nama_penyelenggara') ?? '' }}">
