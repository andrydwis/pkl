                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{route('permohonan-tes-urine-instansi.store')}}">
                                ...
                                <div class="form-group">
                                    <label for="tanggal_pelaksanaan_pemeriksaan" class="control-label">Tanggal Pelaksanaan Pemeriksaan</label>
                                    <input id="tanggal_pelaksanaan_pemeriksaan" type="Date"
                                        class="form-control @error('tanggal_pelaksanaan_pemeriksaan'){{'is-invalid'}}@enderror" name="tanggal_pelaksanaan_pemeriksaan">
                                ...
                                <div class="form-group">
                                    <label for="waktu_pelaksanaan_pemeriksaan" class="control-label">Waktu Pelaksanaan Pemeriksaan</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="jumlah_peserta_perempuan" type="number"
                                            ...
                                            name="jumlah_peserta_perempuan" value="{{old('jumlah_peserta_perempuan') ?? ''}}">
