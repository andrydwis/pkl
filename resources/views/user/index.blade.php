            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="500">
                    <div class="icon-box" id="skhpn">
                        ...
                        <h2 style="text-align: center;">
                            <a href="{{ route('skhpn.create') }}">SKHPN</a>
                        </h2>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="500">
                    <div class="icon-box" id="permohonan-tes-urine-mandiri">
                        <div class="icon"><i class="far fa-id-card"></i></div>
                        <h2 style="text-align: center;">
                            <a href="{{ route('permohonan-tes-urine-instansi.create') }}">Permohonan Tes Urine Instansi</a>
                        </h2>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="600">
                    <div class="icon-box" id="survey-kepuasan-pasien">
                        ...
                        <h2 style="text-align: center;">
                            <a href="">Survey Kepuasan Pasien</a>
                        </h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card bg-white shadow rounded">
                        <div class="card-body">
                            <p>
                                ...
                                bawah dan bertanggungjawab kepada Badan Narkotika Nasional Propinsi dan Badan Narkotika Nasional.
                                Badan Narkotika Nasional merupakan lembaga yang bertujuan untuk melakukan Program Pencegahan dan
                            ...
                            <p>
                                ...
                                (Satuan Kerja Perangkat Daerah) yang berada di bawah Pemerintah Kota Malang dikepalai oleh Ketua
                                Badan Narkotika Kota Malang yang dijabat oleh Wakil Walikota Malang Drs. BAMBANG PRIYO UTOMO, B.Sc.
                            </p>
                            <p>
                                ...
                                tugas sehari-hari adalah melaksanakan fungsi pelaksana harian Ketua Badan Narkotika Kota Malang.
                                Sedangkan anggota dari BNK Kota Malang adalah dari berbagai unsur Pemerintahan, Kepolisian, Kejaksaan,
