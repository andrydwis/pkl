    ...
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up"
        ...
        <div class="d-lg-flex">
          ...
          <a href="https://www.youtube.com/watch?v=c0-5Oxb5oyE" class="venobox btn-watch-video" data-vbtype="video"
            data-autoplay="true">
  ...
  <section id="sop-services" class="services section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="500">
          <div class="icon-box">
            <div class="icon"><i class="bx bx-tachometer"></i></div>
        ...
        <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="600">
          <div class="icon-box">
            <div class="icon"><i class="bx bx-tachometer"></i></div>
